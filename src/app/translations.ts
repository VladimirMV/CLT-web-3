...
export const translations = {
  EN: {
    ...
    solutions: {
      ...
      dazzler: {
        name: 'LASER DAZZLER',
        category: 'Stationary System',
        power: '400 W',
        range: 'Up to 2 km',
        targets: 'UAVs class 1-2, drones',
        description: 'Compact system for protecting critical infrastructure and facility perimeters',
      },
      jammer: {
        name: 'LASER JAMMER',
        category: 'Modular System',
        power: 'Energy up to 1 J',
        range: 'Up to 500 meters',
        targets: 'FPV, bombers',
        description: 'Universal medium-range system for military facilities',
      },
      antyspy: {
        name: 'LASER ANTYSPY',
        ...
        power: 'Energy 2-3 J',
        range: 'Up to 5 km',
        targets: 'Reconnaissance UAVs. Optics destruction',
        description: 'High-power system for protection against reconnaissance UAVs',
      },
      specs: {
        power: 'Power',
        range: 'Range',
  ...
  UA: {
    ...
    solutions: {
      ...
      dazzler: {
        name: 'LASER DAZZLER',
        category: 'Стаціонарна система',
        power: '400 Вт',
        range: 'До 2 км',
        targets: 'БПЛА класу 1-2, дрони',
        description: 'Компактна система для захисту критичної інфраструктури та периметра об\'єктів',
      },
      jammer: {
        name: 'LASER JAMMER',
        category: 'Модульна система',
        power: 'Енергія до 1 Дж',
        range: 'До 500 метрів',
        targets: 'FPV, бомбери',
        description: 'Універсальна система середнього радіусу дії для військових об\'єктів',
      },
      antyspy: {
        name: 'LASER ANTYSPY',
        category: 'Мобільна платформа',
        power: 'Енергія 2-3 Дж',
        range: 'До 5 км',
        targets: 'БПЛА розвідники. Ураження оптики',
        description: 'Високопотужна система для захисту від БПЛА розвідників',
      },
      specs: {
        power: 'Потужність',
        range: 'Дальність',
